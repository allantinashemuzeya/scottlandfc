<?php use App\Facades\AnitaConfig;use Illuminate\Support\Facades\Route; ?>
    <!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<?php if(isset($hasBackground) && isset($data->cover)): ?>
    <!-- Page Background -->
    <div class="anita-page-background-wrap">
        <div class="anita-page-background" data-src="<?php echo e($data->cover->url); ?>" data-opacity="0.05"></div>
    </div>
...
<?php /**PATH /var/www/scotfc.allanmuzeya.com/resources/views/layouts/Home.blade.php ENDPATH**/ ?>
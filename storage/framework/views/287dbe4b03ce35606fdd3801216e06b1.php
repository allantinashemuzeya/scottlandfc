...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.webGL-carousel-gallery','data' => ['data' => $homePageData]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['data' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($homePageData)]); ?>
...
<?php echo $__env->make('layouts.Home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/allanmuzeya/Herd/hervelewis-blade/resources/views/Home.blade.php ENDPATH**/ ?>